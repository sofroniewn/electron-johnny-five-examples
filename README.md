...
Each example is [npm](https://www.npmjs.com/) installable and comes with its own README.md. To get started, check out the first one [1-led](https://github.com/sofroniewn/electron-johnny-five-examples/tree/master/1-led)!
